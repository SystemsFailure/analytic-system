...
// управление темой и конфиг приложения
const colorMode = useColorMode()
const appConfig = useAppConfig()

// список цветов для выбора темы
...
// элементы дропдауна: профиль, тема, шаблоны и ссылки
...
<template>
  ...
  >
    ...
    <!-- слот для отображения цветной «чип»-индикации -->
